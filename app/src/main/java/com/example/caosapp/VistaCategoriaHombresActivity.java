...
public class VistaCategoriaHombresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vista_categoria_hombres);
        initComponent();
        loadInformation();
        onItemSelectetSpinner();
    }

    public void goToVistaComprar(View view) {
        Intent intent = new Intent(this, VistaComprarrActivity.class);
